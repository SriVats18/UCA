...
const Contact = () => {
  return (
    <>
    <div id='contact' className='bg-[url("https://i.pinimg.com/564x/39/9b/b4/399bb4bf47aad332a25d4cdcb0fa79b0.jpg")] bg-[length:630px_800px] md:bg-[length:1550px_800px] bg-no-repeat bg-fixed text-white'>
      ...
      <div className='grid place-content-center h-screen w-full font-averia px-4 text-center text-xl'>
        <form className='flex flex-col gap-5'>
          <label for='name' className='flex gap-14 justify-end items-center'>
            ...
            <input type="text" name="name" id='name' placeholder='Your Name' className="rounded-lg px-2 py-1"/>
          </label>
          
          <label for="email" className='flex gap-14 justify-end items-center'>
            <span className="text-3xl font-bold">Email: </span>
            <input type="text" name="email" id="email" cols="10" placeholder="you@gmail.com" className="rounded-lg px-2 py-1" />
          </label>

          <label for="Textarea" className='flex gap-14 justify-end items-center'>
            <span className="text-3xl font-bold">Message: </span>
            <textarea name="textarea" id="Textarea" rows="3" placeholder="Type Something.." className="rounded-lg px-2 py-1"></textarea>
          </label>
