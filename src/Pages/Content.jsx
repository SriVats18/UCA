...
const Content = () => {
  return (
    <>
    <div id='content' className='bg-[url("https://i.pinimg.com/564x/39/9b/b4/399bb4bf47aad332a25d4cdcb0fa79b0.jpg")] bg-[length:630px_800px] bg-fixed bg-no-repeat text-white md:bg-[length:1550px_800px]'>
      ...
      <div className='flex h-screen w-full flex-row items-center justify-around p-4 font-averia font-extrabold text-2xl md:text-4xl'>
